...
class MGWPP_Single_Gallery_Editor_Options {
    ...
    public static function save_meta( $post_id ) {
        if ( ! isset( $_POST['mgwpp_single_options_nonce'] ) ) return;
        if ( ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['mgwpp_single_options_nonce'] ) ), 'mgwpp_single_options_nonce' ) ) return;

...
class MGWPP_Modules_View
{
     ...
     * Available At class-mgwpp-settings.php 
     */
...
<?php
    ...
    public function ajax_toggle_module()
    {
        ...
        $enabled_modules = array_combine($enabled_modules, $enabled_modules);
        ...
        update_option('mgwpp_enabled_modules', array_values($enabled_modules));

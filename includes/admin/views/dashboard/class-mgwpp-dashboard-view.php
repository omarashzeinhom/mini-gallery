...
class MGWPP_Dashboard_View
{
    ...
    public function enqueue_assets($hook) {
        if ($hook === 'toplevel_page_mgwpp_dashboard') {
            $css_path = MG_PLUGIN_PATH . '/includes/admin/views/dashboard/mgwpp-dashboard-view.css';
            $js_path = MG_PLUGIN_PATH . '/includes/admin/views/dashboard/mgwpp-dashboard-view.js';

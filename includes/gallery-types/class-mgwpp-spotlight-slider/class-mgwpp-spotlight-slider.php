...
class MGWPP_Spotlight_Slider {
    public static function render( $post_id, $images, $settings = [] ) {
        ...
        ob_start();
        ?>
        <div class="mgwpp-spotlight-slider">
            <div class="mgwpp-light-overlay"></div>
            
            <div class="mgwpp-slider-viewport">
                ...
                ?>
                    <div class="mgwpp-slider-slide <?php echo ( $index === 0 ? 'mgwpp-active' : '' ); ?>">

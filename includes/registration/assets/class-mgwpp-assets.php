...
class MGWPP_Assets {
    ...
    private function get_enabled_modules() {
        return get_option('mgwpp_enabled_modules', array(
            'single_carousel',
            'multi_carousel',
            'grid',
            'mega_slider',
    ...
    public function register_assets() {
        ...
        if (in_array('lightbox', $enabled)) {
            wp_register_script('mgwpp-lightbox-js', $base_url . 'js/mg-lightbox.js', array('jquery'), file_exists(MG_PLUGIN_PATH . 'public/js/mg-lightbox.js') ? filemtime(MG_PLUGIN_PATH . 'public/js/mg-lightbox.js') : '1.0', true);
        }
        ...
        if (in_array('albums', $enabled)) {
            wp_register_style('mg-album-styles', $base_url . 'css/mg-album-styles.css', array(), file_exists(MG_PLUGIN_PATH . '/public/css/mg-album-styles.css') ? filemtime(MG_PLUGIN_PATH . '/public/css/mg-album-styles.css') : '1.0');
            wp_register_script('mg-albums-script', $base_url . 'js/mg-albums.js', array(), file_exists(MG_PLUGIN_PATH . '/public/js/mg-albums.js') ? filemtime(MG_PLUGIN_PATH . '/public/js/mg-albums.js') : '1.0', true);
        }
    }

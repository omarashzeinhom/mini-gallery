...
jQuery(window).on('elementor/frontend/init', () => {
    elementorFrontend.hooks.addAction('frontend/element_ready/mg_neon_carousel.default', ($scope) => {
...
document.querySelectorAll('.neon-slider:not(.elementor-element .neon-slider)').forEach(slider => {
